...
public class EsapiHtmlResponseWriterImpl extends HtmlResponseWriterImpl
{
    ...
    public void writeAttribute(String name, Object value, String componentPropertyName) throws IOException
    {
        ...
        else
        {
            ...
            // strValue = ESAPI.encoder().encodeForHTMLAttribute(strValue);
    ...
    public void write(String str, int off, int len) throws IOException
    {
        ...
        if(UTF8.equals(_characterEncoding))
        {
        	// String safe  = ""; new changes.
        	// if(strValue != null && !strValue.trim().endsWith("")) new changes.
        	//safe = getSafeHtmlCode(strValue); new changes.
        	_currentWriter.write(strValue);
        }
        else
        {
